...
export const BRAND_TOV_GUIDELINES: Record<string, {
  ...
  sloggi: {
    ...
    rules: [
      'Brand essence: "Liberating true comfort" — proposition: "Move comfortably through our world"',
      'Use simple, clear, direct language — straight talking, no euphemisms',
      'Write peer-to-peer: use "we" and "our" naturally — don\'t "other" the audience',
      'Emphasise comfort, freedom of movement, and everyday wearability',
      'Celebrate inclusivity — sloggi is for everyone who wears underwear',
      'Be joyful and positive without being silly or humorous',
      'Highlight innovation through the lens of comfort (ZERO, ADAPT, EVER, GO, ORIGINALS)',
      'Keep it real and honest — no aspirational or exclusive positioning',
    ],
    avoid: [
      'Luxury or aspirational language — sloggi is for everyone, not exclusive',
      'Humour, puns, or jokes — global brand, humour doesn\'t translate',
      'Gendered greetings ("hey ladies", "go girls") — not everyone wearing a bra is a woman',
      'Forced friendliness or phoney matey tone',
      'Complex sentence structures or pretentious vocabulary',
      'Objectifying or inappropriate language',
      'Overly technical jargon without comfort context',
    ],
  },
  beldona: {
    name: 'Beldona',
